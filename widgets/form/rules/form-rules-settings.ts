...
import { FormRuleActionExecutor } from './extractors/form-rule-action-extractor';
...
export class FormRulesSettings {
    ...
    public ActionExecutors: { actionName: string, actionExecutor: FormRuleActionExecutor }[] = [];
    ...
    public addActionExecutor (actionName: string, actionExecutor: FormRuleActionExecutor) {
